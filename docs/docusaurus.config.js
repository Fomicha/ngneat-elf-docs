  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/ngneat-archive/elf/',
          label: ' ',
          position: 'right',
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'Discussions',
              href: 'https://github.com/ngneat-archive/elf/discussions',
            },
          ],
        },
        {
    ...
    [
      '@docusaurus/preset-classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/ngneat-archive/elf/edit/restore/npm-elf-cli-3.1.1/docs/',
        },
        theme: {
